...
#define  Empty_BUFFER0()                   ((UART0_STATUS & (1<<UDRE)))
#define  FRAME_ERROR0()                    ((UART0_STATUS & (1<<FE)))
...
#define UART0_UDREMPTY_INTERRUPT   USART0_UDRE_vect

#define UART1_RECEIVE_INTERRUPT    USART1_RX_vect
#define UART1_TRANSMIT_INTERRUPT   USART1_TX_vect
#define UART1_UDREMPTY_INTERRUPT   USART1_UDRE_vect
...
#define  FRAME_ERROR0()                    ((UART0_STATUS & (1<<FE0)))
#define  FRAME_ERROR1()                    ((UART1_STATUS & (1<<FE1)))
...
#define   BUAD0_REG            35
#define     USART0_BIT_DURATION                52           
#define     USART0_BYTE_DURATION                (uint16_t) (520) 
...
#define  DISPABLE_RECEIVER()                  UART0_CONTROL &=~_BV(RXEN);
#define  ENABLE_RECEIVER()                    UART0_CONTROL |=_BV(RXEN);
...
#define   BUAD1_REG            35
#define     USART1_BIT_DURATION                52           
#define     USART1_BYTE_DURATION                (uint16_t) (520) 
